...
Model3DS::~Model3DS () { lib3ds_file_free (file); }
                    ...
                    if (mat->texture1_map.name[0]) { /* texture map? */
                        ...
                        if (!tex->user.p) { /* no player texture yet? */
...
#else                                         /* USE_SDL */
                            pt->bitmap = NULL;
                            fputs ("3dsplayer: Warning: No image loading support, skipping "
                                   "texture.\n",
                                   stderr);
#endif                                        /* USE_SDL */
                            if (pt->bitmap) { /* could image be loaded ? */
                                ...
                                glTexImage2D (GL_TEXTURE_2D, 0, GL_RGBA, TEX_XSIZE, TEX_YSIZE, 0,
                                ...
                                glTexSubImage2D (GL_TEXTURE_2D, 0, 0, 0, pt->bitmap->w,
                                                 pt->bitmap->h, upload_format, GL_UNSIGNED_BYTE,
                                                 pixel);
