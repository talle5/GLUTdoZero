...
void Desenha::drawBox (GLfloat xmin, GLfloat ymin, GLfloat zmin, GLfloat xmax, GLfloat ymax,
                       GLfloat zmax)
{
    glBegin (GL_QUADS);
    glNormal3f (0., 0., -1.);
...
//---------------------------------------------------------------------------
// Draws a simple box using the given corners
void Desenha::drawWireBox (GLfloat xmin, GLfloat ymin, GLfloat zmin, GLfloat xmax, GLfloat ymax,
                           GLfloat zmax)
{
    glBegin (GL_LINES);
    glVertex3f (xmin, ymin, zmin);
...
void Desenha::drawSelectedBox (GLfloat xmin, GLfloat ymin, GLfloat zmin, GLfloat xmax,
                               GLfloat ymax, GLfloat zmax)
{
...
void Desenha::gluClosedCylinder (GLUquadric *quad, GLdouble base, GLdouble top, GLdouble height,
...
void Desenha::gluCapsule (GLUquadric *quad, GLdouble base, GLdouble top, GLdouble height,
                          GLint slices, GLint stacks)
{
    gluQuadricNormals (quad, GLU_SMOOTH); // Create Smooth Normals
    gluQuadricTexture (quad, GL_TRUE);    // Create Texture Coords
